...
public class CustomCommentGenerator implements CommentGenerator {
	...
	public void addFieldComment(Field field, IntrospectedTable introspectedTable, IntrospectedColumn introspectedColumn) {
		...
		if(introspectedColumn.isJDBCTimeColumn() || "TIMESTAMP".equals(introspectedColumn.getJdbcTypeName())) {
	...
	public void addModelClassComment(TopLevelClass arg0, IntrospectedTable arg1) {
		arg0.addImportedType("org.springframework.format.annotation.DateTimeFormat");
		arg0.addImportedType("com.fasterxml.jackson.annotation.JsonFormat");
	}
